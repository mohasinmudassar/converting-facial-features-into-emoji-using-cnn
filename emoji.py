...
def show_subject():      
    cap1 = cv2.VideoCapture(r'video_link or in case of live camers put 0')                                 
    ...
    bounding_box = cv2.CascadeClassifier('Enter the path of datahaarcascade_frontalface_default.xml')
